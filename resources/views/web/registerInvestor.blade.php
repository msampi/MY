...
<!--    <div class="bg-china"></div>-->
    <div class="container mt-5 mb-5">
        ...
        <form id="register-form" class="form-horizontal" role="form" method="POST" action="{{ url('investor-register') }}">
            {{ csrf_field() }}
            <div id="register_investor_id"></div>
            <div class="row">
                <div class="col-md-6 register-form">
                    ...
                    <div class="row">
                        ...
                        <div>
                            {!!  GoogleReCaptchaV3::renderOne('register_investor_id','register_investor') !!}
                        </div>
                        <div class="col-md-12 m-3">
                            <a onclick="validateForm()" class="btn btn-primary btn-rounded btn-lg btn-full">
                                Register
                            </a>
                        </div>
                    </div>
