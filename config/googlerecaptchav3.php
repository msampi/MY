...
return [
    ...
    */
    ...
    |
    */
    'secret_key' => env('RECAPTCHA_V3_SECRET_KEY', '6LfjAg0aAAAAAIrnkGzscv-ysLXgprWZLxsmkuIc'),
    /*
    |--------------------------------------------------------------------------
    | Site Key
    |--------------------------------------------------------------------------
    ...
    |
    */
    'site_key' => env('RECAPTCHA_V3_SITE_KEY', '6LfjAg0aAAAAAJ-SD28-Mx79DaGA4zW_bOoI6mv0'),
